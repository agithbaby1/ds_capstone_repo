...
launch_sites = list(spacex_df['Launch Site'].value_counts().keys().values) 
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        data = filtered_df.value_counts(['class']).reset_index(name='count')
        fig = px.pie(data, values='count', 
        names='class', 
        title='Launch Success for {}'.format(entered_site))
        return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        title='Payload Correlation with Mission Outcomes for All Sites')
        return fig
    else:
        ...
        color='Booster Version Category',  
        title='Payload Correlation with Mission Outcomes for {}'.format(entered_site))
        return fig
